...
class UsageTracker {
    ...
    /// If last threshold was X minutes ago and we're between events, simulate progress
    ...
    func getCurrentTimeSpent() -> TimeInterval {
        ...
        logger.info("MARKERS   - consumedMinutes: \(consumedMinutes)")
        
        NSLog("MARKERS   - consumedMinutesTimestamp: %.0f", consumedMinutesTimestamp)
        print("MARKERS   - consumedMinutesTimestamp: \(consumedMinutesTimestamp)")
