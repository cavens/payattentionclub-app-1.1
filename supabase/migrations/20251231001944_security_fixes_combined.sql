...
-- Date: 2025-12-31
-- Purpose: Apply critical security fixes to RPC functions
-- ==============================================================================
-- 
-- This migration applies two critical security fixes:
-- 1. rpc_preview_max_charge - Require authentication
-- 2. rpc_setup_test_data - Restrict to test users only
-- ==============================================================================
...
-- ==============================================================================
-- Note: This is a large function, so we'll apply the security checks
-- The full function body is in the separate migration file
