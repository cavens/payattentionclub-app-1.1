-- ==============================================================================
-- Migration: Update rpc_create_commitment Function Signature
-- ==============================================================================
-- Date: 2026-01-15
-- Purpose: Ensure rpc_create_commitment has the correct signature with all parameters
--          including p_deadline_timestamp for testing mode support
-- ==============================================================================

-- Drop the function if it exists with any signature to avoid conflicts
...
GRANT EXECUTE ON FUNCTION public.rpc_create_commitment(date, integer, integer, integer, jsonb, text, timestamptz) TO authenticated;
