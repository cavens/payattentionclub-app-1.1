-- ==============================================================================
-- Set Service Role Key for Production (Alternative Method)
-- ==============================================================================
...
-- Insert or update the service role key for production
-- ⚠️ IMPORTANT: Replace YOUR_PRODUCTION_SERVICE_ROLE_KEY with the actual key from your .env file
-- DO NOT commit actual keys to git!
INSERT INTO public._internal_config (key, value) 
VALUES (
    'service_role_key', 
    'YOUR_PRODUCTION_SERVICE_ROLE_KEY_FROM_ENV'
)
