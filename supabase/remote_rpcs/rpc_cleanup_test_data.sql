...
-- Safe to run repeatedly - uses DELETE with WHERE clauses.
-- 
-- Test user IDs (matching rpc_setup_test_data):
--   - 11111111-1111-1111-1111-111111111111 (test_user_1)
--   - 22222222-2222-2222-2222-222222222222 (test_user_2)
--   - 33333333-3333-3333-3333-333333333333 (test_user_3)
--   - 44444444-4444-4444-4444-444444444444 (seed_real_user fallback)
-- ============================================
